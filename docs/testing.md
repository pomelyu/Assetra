...
- [x] 帳戶管理新增流程只提供一般與投資帳戶，並路由至對應編輯頁
- [x] 新增投資帳戶時依幣別篩選資金來源，無候選時停用，儲存後刷新清單
- [x] 帳戶管理顯示投資帳戶預設資金來源，編輯改派後刷新
- [x] 投資帳戶詳情新增交易時只提供投資交易並預填帳戶及預設資金來源
- [x] 投資買入成功後刷新投資帳戶與一般資金帳戶
